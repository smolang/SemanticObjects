...
WORKDIR /root/smol
CMD ["java", "-jar", "/usr/local/src/smol/build/libs/smol.jar"]
# CMD java -jar /usr/local/src/smol/build/libs/smol.jar -i examples/House/osphouseV2.smol -e -b examples/House/rooms.owl -p asset=https://github.com/Edkamb/SemanticObjects/Asset# -m
