class <A, B> Pair(A key, B value) end

class <S> Node(Pair<Int, S> dataL,
                  Pair<Int, S> dataR,
                  Node<S> childL,
                  Node<S> childM,
                  Node<S> childR,
...
class <Z> Wrap(Tree<Z> ttt, Int key)
    rule Z lookup()
...
class <D> List(D content, List<D> next)
    Int length()
...
main
    Node<String> root := new Node(null, null, null, null, null, null);
    Tree<String> tree := new Tree(root);
    Pair<Int, String> pair1 := new Pair(1,"a");
    Pair<Int, String> pair2 := new Pair(2,"b");
    Pair<Int, String> pair3 := new Pair(3,"c");
    Pair<Int, String> pair4 := new Pair(4,"d");
    Pair<Int, String> pair5 := new Pair(5,"e");
    Pair<Int, String> pair6 := new Pair(6,"f");
    Pair<Int, String> pair7 := new Pair(7,"g");
    tree.add(pair3);
    tree.add(pair2);
    tree.add(pair1);
    tree.add(pair7);
    ...
    Wrap<String> ww := new Wrap(tree, 1);
    //res := ww.lookup();
