...
abstract class Type {
    ...
    open fun isAssignable(rhs : Type, extends : MutableMap<String, String>) : Boolean {
...
data class SimulatorType(val inVar : List<Pair<String, Type>>, val outVar : List<Pair<String, Type>>) : SimpleType() {
    ...
    override fun isAssignable(rhs : Type, extends : MutableMap<String, String>) : Boolean  =
...
data class GenericType(val name : String) : SimpleType() {
    ...
    override fun isAssignable(rhs: Type, extends: MutableMap<String, String>): Boolean = super.isAssignable(rhs, extends)
}
...
data class ComposedType(val name : Type, val params : List<Type>) : Type() {
    ...
    override fun isAssignable(rhs : Type, extends : MutableMap<String, String>) : Boolean {
        ...
        if(rhs !is ComposedType) return false
